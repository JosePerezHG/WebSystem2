...
Events::on('post_controller_constructor', function () {
	 ...
	 $class = strtoupper($router->controllerName()); //Class llamada
  	$method = strtoupper($router->methodName()); //metodo llamado
  		...
  		$nocontrolados = array('\APP\CONTROLLERS\PORTADA','\APP\CONTROLLERS\LOGIN','\APP\CONTROLLERS\TEMA','\APP\CONTROLLERS\ERRORACCESO',
  			'\APP\CONTROLLERS\BLOG',
  			'\APP\CONTROLLERS\REPORTES','\APP\CONTROLLERS\SERVICIO','\APP\CONTROLLERS\CONTACTANOS','\APP\CONTROLLERS\REGISTROUSUARIO');  
